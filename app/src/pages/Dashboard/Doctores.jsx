                            ...
                            <div className="col-sm-12">
                                ...
                                <div className="table-responsive">
                                    <table className="table"
                                        ...
                                        <thead>
                                            <tr 
                                            style={{background: "#8dc2fe" }}>
                                                <th scope="col"
                                                    style={{ width: "5%", border: "1px solid #000"}}>#</th>
                                                <th scope="col"
                                                    style={{ width: "25%", border: "1px solid #000"}}>Paciente</th>
                                                <th scope="col"
                                                    style={{ width: "20%", border: "1px solid #000"}}>Cita</th>
                                                <th scope="col"
                                                    style={{ width: "15%",border: "1px solid #000"}}>Estado</th>
                                                
                                                <th scope="col"
                                                    style={{ width: "15%",border: "1px solid #000"}} >Estado del pago</th>
                                                <th scope="col"
