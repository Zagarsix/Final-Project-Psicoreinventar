...
const LoginForm = () => {
  ...
  // If user signed in, redirect to update profile page, need to work on this
  useEffect(() => {
    if (store.currentUser !== null) navigate("/specialists");
    // JUST FOR TESTING, SHOULD REDIRECT TO UPDATE PROFILE
