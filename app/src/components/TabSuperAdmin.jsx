            ...
            <table className="table table-borderer table-sm">
              ...
              >
                <tr>
                  ...
                  <td style={{ border: "1px solid #000" }}>Joe Opino</td>
                  <td style={{ border: "1px solid #000" }}>
                    13 de Agosto, 2022. 10:00 hrs
                  </td>
            ...
            <table className="table table-borderer table-sm">
              <thead>
                <tr style={{ backgroundColor: "#6495ed" }}>
                  ...
                  <th
                    scope="col"
                    sstyle={{ width: "20%", border: "1px solid #000" }}
                  >
                    Información
                  </th>
                  <th
                  ...
                  <th
                    scope="col"
                    sstyle={{ width: "15%", border: "1px solid #000" }}
                  >
                    Próximas citas
                  </th>
                  <th
            ...
            <table className="table table-borderer table-sm">
              ...
              >
                <tr>
                  ...
                  <td style={{ border: "1px solid #000" }}>Juan Bodoque</td>
                  <td style={{ border: "1px solid #000" }}>Disponibilidad</td>
                  <td style={{ border: "1px solid #000" }}>
